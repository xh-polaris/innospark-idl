...
type Conversation struct {
	...
	Ext            map[string]string `protobuf:"bytes,6,rep,name=ext" json:"ext,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // 额外信息
}
...
type Profile struct {
	...
	Grade   *string `protobuf:"bytes,2,opt,name=grade" json:"grade,omitempty"`
...
func (x *GetConversationExtReq) Reset() { *x = GetConversationExtReq{} }

func (x *GetConversationExtReq) Marshal(in []byte) ([]byte, error) {
	return prutal.MarshalAppend(in, x)
}

func (x *GetConversationExtReq) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
...
type GetConversationExtResp struct {
	Resp *basic.Response   `protobuf:"bytes,1,opt,name=resp" json:"resp,omitempty"`
	Ext  map[string]string `protobuf:"bytes,2,rep,name=ext" json:"ext,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}

func (x *GetConversationExtResp) Reset() { *x = GetConversationExtResp{} }

func (x *GetConversationExtResp) Marshal(in []byte) ([]byte, error) {
	return prutal.MarshalAppend(in, x)
}

func (x *GetConversationExtResp) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
...
func (x *UpdateConversationExtReq) Reset() { *x = UpdateConversationExtReq{} }

func (x *UpdateConversationExtReq) Marshal(in []byte) ([]byte, error) {
	return prutal.MarshalAppend(in, x)
}

func (x *UpdateConversationExtReq) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
...
func (x *UpdateConversationExtResp) Reset() { *x = UpdateConversationExtResp{} }

func (x *UpdateConversationExtResp) Marshal(in []byte) ([]byte, error) {
	return prutal.MarshalAppend(in, x)
}

func (x *UpdateConversationExtResp) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
...
func (x *SendVerifyCodeResp) Reset() { *x = SendVerifyCodeResp{} }

func (x *SendVerifyCodeResp) Marshal(in []byte) ([]byte, error) { return prutal.MarshalAppend(in, x) }

func (x *SendVerifyCodeResp) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
...
type BasicUserRegisterReq struct {
	AuthType string `protobuf:"bytes,1,opt,name=authType" json:"authType,omitempty"`
	AuthId   string `protobuf:"bytes,2,opt,name=authId" json:"authId,omitempty"`
	Verify   string `protobuf:"bytes,3,opt,name=verify" json:"verify,omitempty"`
	Password string `protobuf:"bytes,4,opt,name=password" json:"password,omitempty"`
}

func (x *BasicUserRegisterReq) Reset() { *x = BasicUserRegisterReq{} }

func (x *BasicUserRegisterReq) Marshal(in []byte) ([]byte, error) { return prutal.MarshalAppend(in, x) }

func (x *BasicUserRegisterReq) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
...
func (x *BasicUserRegisterResp) Reset() { *x = BasicUserRegisterResp{} }

func (x *BasicUserRegisterResp) Marshal(in []byte) ([]byte, error) {
	return prutal.MarshalAppend(in, x)
}

func (x *BasicUserRegisterResp) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
...
func (x *BasicUserLoginReq) Reset() { *x = BasicUserLoginReq{} }

func (x *BasicUserLoginReq) Marshal(in []byte) ([]byte, error) { return prutal.MarshalAppend(in, x) }

func (x *BasicUserLoginReq) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
...
func (x *BasicUserLoginResp) Marshal(in []byte) ([]byte, error) { return prutal.MarshalAppend(in, x) }

func (x *BasicUserLoginResp) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
