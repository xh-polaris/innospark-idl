...
type Client interface {
	...
	GetConversationExt(ctx context.Context, Req *core_api.GetConversationExtReq, callOptions ...callopt.Option) (r *core_api.GetConversationExtResp, err error)
	UpdateConversationExt(ctx context.Context, Req *core_api.UpdateConversationExtReq, callOptions ...callopt.Option) (r *core_api.UpdateConversationExtResp, err error)
...
func (p *kCoreApiClient) GetConversationExt(ctx context.Context, Req *core_api.GetConversationExtReq, callOptions ...callopt.Option) (r *core_api.GetConversationExtResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetConversationExt(ctx, Req)
}

func (p *kCoreApiClient) UpdateConversationExt(ctx context.Context, Req *core_api.UpdateConversationExtReq, callOptions ...callopt.Option) (r *core_api.UpdateConversationExtResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UpdateConversationExt(ctx, Req)
}
