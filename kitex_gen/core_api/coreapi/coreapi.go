...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"GetConversationExt": kitex.NewMethodInfo(
		getConversationExtHandler,
		newGetConversationExtArgs,
		newGetConversationExtResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingUnary),
	),
	"UpdateConversationExt": kitex.NewMethodInfo(
		updateConversationExtHandler,
		newUpdateConversationExtArgs,
		newUpdateConversationExtResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingUnary),
	),
...
func getConversationExtHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(core_api.GetConversationExtReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(core_api.CoreApi).GetConversationExt(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetConversationExtArgs:
		success, err := handler.(core_api.CoreApi).GetConversationExt(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetConversationExtResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetConversationExtArgs() interface{} {
	return &GetConversationExtArgs{}
}

func newGetConversationExtResult() interface{} {
	return &GetConversationExtResult{}
}

type GetConversationExtArgs struct {
	Req *core_api.GetConversationExtReq
}

func (p *GetConversationExtArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetConversationExtArgs) Unmarshal(in []byte) error {
	msg := new(core_api.GetConversationExtReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetConversationExtArgs_Req_DEFAULT *core_api.GetConversationExtReq

func (p *GetConversationExtArgs) GetReq() *core_api.GetConversationExtReq {
	if !p.IsSetReq() {
		return GetConversationExtArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetConversationExtArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetConversationExtArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetConversationExtResult struct {
	Success *core_api.GetConversationExtResp
}

var GetConversationExtResult_Success_DEFAULT *core_api.GetConversationExtResp

func (p *GetConversationExtResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetConversationExtResult) Unmarshal(in []byte) error {
	msg := new(core_api.GetConversationExtResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GetConversationExtResult) GetSuccess() *core_api.GetConversationExtResp {
	if !p.IsSetSuccess() {
		return GetConversationExtResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetConversationExtResult) SetSuccess(x interface{}) {
	p.Success = x.(*core_api.GetConversationExtResp)
}

func (p *GetConversationExtResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetConversationExtResult) GetResult() interface{} {
	return p.Success
}

func updateConversationExtHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(core_api.UpdateConversationExtReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(core_api.CoreApi).UpdateConversationExt(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UpdateConversationExtArgs:
		success, err := handler.(core_api.CoreApi).UpdateConversationExt(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*UpdateConversationExtResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newUpdateConversationExtArgs() interface{} {
	return &UpdateConversationExtArgs{}
}

func newUpdateConversationExtResult() interface{} {
	return &UpdateConversationExtResult{}
}

type UpdateConversationExtArgs struct {
	Req *core_api.UpdateConversationExtReq
}

func (p *UpdateConversationExtArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *UpdateConversationExtArgs) Unmarshal(in []byte) error {
	msg := new(core_api.UpdateConversationExtReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var UpdateConversationExtArgs_Req_DEFAULT *core_api.UpdateConversationExtReq

func (p *UpdateConversationExtArgs) GetReq() *core_api.UpdateConversationExtReq {
	if !p.IsSetReq() {
		return UpdateConversationExtArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *UpdateConversationExtArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *UpdateConversationExtArgs) GetFirstArgument() interface{} {
	return p.Req
}

type UpdateConversationExtResult struct {
	Success *core_api.UpdateConversationExtResp
}

var UpdateConversationExtResult_Success_DEFAULT *core_api.UpdateConversationExtResp

func (p *UpdateConversationExtResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *UpdateConversationExtResult) Unmarshal(in []byte) error {
	msg := new(core_api.UpdateConversationExtResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *UpdateConversationExtResult) GetSuccess() *core_api.UpdateConversationExtResp {
	if !p.IsSetSuccess() {
		return UpdateConversationExtResult_Success_DEFAULT
	}
	return p.Success
}

func (p *UpdateConversationExtResult) SetSuccess(x interface{}) {
	p.Success = x.(*core_api.UpdateConversationExtResp)
}

func (p *UpdateConversationExtResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UpdateConversationExtResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) GetConversationExt(ctx context.Context, Req *core_api.GetConversationExtReq) (r *core_api.GetConversationExtResp, err error) {
	var _args GetConversationExtArgs
	_args.Req = Req
	var _result GetConversationExtResult
	if err = p.c.Call(ctx, "GetConversationExt", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) UpdateConversationExt(ctx context.Context, Req *core_api.UpdateConversationExtReq) (r *core_api.UpdateConversationExtResp, err error) {
	var _args UpdateConversationExtArgs
	_args.Req = Req
	var _result UpdateConversationExtResult
	if err = p.c.Call(ctx, "UpdateConversationExt", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
