...
type CoreApi interface {
	...
	GetConversationExt(ctx context.Context, req *GetConversationExtReq) (res *GetConversationExtResp, err error)
	UpdateConversationExt(ctx context.Context, req *UpdateConversationExtReq) (res *UpdateConversationExtResp, err error)
