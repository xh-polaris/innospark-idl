...
func (x *GetWeeklyStatsReq) Reset() { *x = GetWeeklyStatsReq{} }

func (x *GetWeeklyStatsReq) Marshal(in []byte) ([]byte, error) { return prutal.MarshalAppend(in, x) }

func (x *GetWeeklyStatsReq) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }

type GetWeeklyStatsResp struct {
	Resp             *basic.Response `protobuf:"bytes,1,opt,name=resp" json:"resp,omitempty"`
	TotalUsers       int64           `protobuf:"varint,2,opt,name=totalUsers" json:"totalUsers,omitempty"`
	NewUsersThisWeek int64           `protobuf:"varint,3,opt,name=newUsersThisWeek" json:"newUsersThisWeek,omitempty"`
	NewUsersLastWeek int64           `protobuf:"varint,4,opt,name=newUsersLastWeek" json:"newUsersLastWeek,omitempty"`
	WeeklyAvgDAU     int64           `protobuf:"varint,5,opt,name=weeklyAvgDAU" json:"weeklyAvgDAU,omitempty"`
	MonthlyAvgDAU    int64           `protobuf:"varint,6,opt,name=monthlyAvgDAU" json:"monthlyAvgDAU,omitempty"`
	WeekStart        string          `protobuf:"bytes,7,opt,name=weekStart" json:"weekStart,omitempty"`
	WeekEnd          string          `protobuf:"bytes,8,opt,name=weekEnd" json:"weekEnd,omitempty"`
}

func (x *GetWeeklyStatsResp) Reset() { *x = GetWeeklyStatsResp{} }

func (x *GetWeeklyStatsResp) Marshal(in []byte) ([]byte, error) { return prutal.MarshalAppend(in, x) }

func (x *GetWeeklyStatsResp) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
